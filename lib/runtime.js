...
function getQueues(requirementsRoot) {
  const humanDecisionNeeded = path.join(requirementsRoot, "human-decision-needed");
  return {
    ...
    // Backward-compatible alias used by existing scripts/prompts.
    toClarify: humanDecisionNeeded,
